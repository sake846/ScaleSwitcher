...
namespace ScaleSwitcher.Services
{
    public sealed class AppController : IDisposable
    {
        ...
        {
            System.Windows.Application.Current.Dispatcher.BeginInvoke(() => CycleDpi(restoreCursorPosition: false));
        }
        ...
        private Forms.ToolStripMenuItem CreateResolutionSubMenu(DisplayInfo display, AppLocalization localization)
        {
